...
export class WechatService {
  wechatApi = {
    ...
    createMenu: "/wechat/create-menu", // 创建菜单 post menu
  ...
  listButtons() {
    return this.api.Get(this.wechatApi.listButtons);
  }
  createMenu(wechatButtons: { button: WechatButton[] }) {
    return this.api.Post(this.wechatApi.createMenu, wechatButtons);
  }
  removeMenu() {
    return this.api.Get(this.wechatApi.removeMenu);
  }
