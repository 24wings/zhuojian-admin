...
@Component({
  selector: 'app-send-record-manage-page',
  templateUrl: './send-record-manage-page.component.html',
  styleUrls: ['./send-record-manage-page.component.scss']
})
export class SendRecordManagePageComponent implements OnInit {
